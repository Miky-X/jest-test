...
describe("testing patterns", () => {
  describe("email", () => {
    test.each(["michal@michal.com", "_._@michal.com", "michalZDuzymiimalymiLiterami@xt.pl"])("%s test should be valid", (email) => {
      expect(EMAIL_PATTERN.test(email)).toBeTruthy();
    });

    test.each(["%;@michal.com", " @michal.pl", "michal@"])("%s test should be invalid", (email) => {
    ...
    it("should return valid result", () => {
      expect(EMAIL_PATTERN.test("michal@michal.com")).toBeTruthy();
    });

    it("should return invalid result", () => {
      expect(EMAIL_PATTERN.test("%;michal.com")).toBeFalsy();
    });
  });
});
